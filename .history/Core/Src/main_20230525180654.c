...
int main(void)
{
  ...
  while (1)
  {
    ...
    //   printf("Working:%d: %ld\n", i++, HAL_GetTick());
      HAL_GPIO_WritePin(GPIOF,GPIO_PIN_0, HAL_GPIO_ReadPin(GPIOF, GPIO_PIN_0));
      HAL_GPIO_WritePin(GPIOF,GPIO_PIN_1, HAL_GPIO_ReadPin(GPIOF, GPIO_PIN_1));
      HAL_GPIO_WritePin(GPIOF,GPIO_PIN_2, HAL_GPIO_ReadPin(GPIOF, GPIO_PIN_2));
      HAL_GPIO_WritePin(GPIOF,GPIO_PIN_3, HAL_GPIO_ReadPin(GPIOF, GPIO_PIN_3));
      HAL_GPIO_WritePin(GPIOF,GPIO_PIN_4, HAL_GPIO_ReadPin(GPIOF, GPIO_PIN_4));
      HAL_GPIO_WritePin(GPIOF,GPIO_PIN_5, HAL_GPIO_ReadPin(GPIOF, GPIO_PIN_5));
      HAL_GPIO_WritePin(GPIOF,GPIO_PIN_6, HAL_GPIO_ReadPin(GPIOF, GPIO_PIN_6));
...
static void MX_GPIO_Init(void)
{
  ...
  GPIO_Initure.Pin = GPIO_PIN_0 | GPIO_PIN_1 | GPIO_PIN_2 | GPIO_PIN_3 
  | GPIO_PIN_4 | GPIO_PIN_5 | GPIO_PIN_6 | GPIO_PIN_7;  /* sw1 ~ 8*/
